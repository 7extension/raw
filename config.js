const webhookURL = "https://ptb.discord.com/api/webhooks/1091800592067854366/rB9AdtKx4ToKHHyIfgAsHd1zyz3qtMumz_JBsNp2QFyh4FtANuDzyOZutYwdBduZUywV" // MANDATORY | Your Webhook URL Here
const avatarURL = "https://images-ext-2.discordapp.net/external/LGuIfFqVv7MQ8KfMoCeKux2HX91EwZwew-JjhRlesdw/https/i.imgur.com/3KRRJlk.png" // OPTIONAL | The URL for the PFP of the webhook itself. Must be a link to a supported image format.
...
function sendMessage() { // After submitting the form.
    ...
    var embed = { // Embed to send.
        ...
        title: "Odwołanie od bana!", // Title of the embed
    ...
    var params = { // Parameters to send the request
        username: `ᴏᴅᴡᴏᴌᴀɴɪᴇ ᴏᴅ ʙᴀɴᴀ ᴍɪɴᴇᴄʀᴀғᴛ | ᴅɪsᴄᴏʀᴅ`, // Name of the webhook
    ...
    alert('Wysłano odwołanie!') // Tells the user that the appeal has been sent.
    console.log('Wysłano odwołanie!') // Logs that the appeal has been sent. (For DEVELOPMENT purposes)
}
